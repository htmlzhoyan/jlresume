...
/***/ function(module, exports, __webpack_require__) {
	...
	$('#enter').tap(function(){
	  ...
	  $.getJSON('https://htmlzhoyan.github.io/jlresume/mock/skill.json'+Math.random(),{},function(response){
	    var html = '';
	...
	var mySwiper = new Swiper ('.swiper-container', {
	  ...
	  $('#footer div').eq(1).tap(function(){
	     $('#footer div').css({'background':'#444','color':'#fff'})
	      $(this).css({'background':'#e9e9e9','color':'#31B020'}) 
	    $.getJSON('https://htmlzhoyan.github.io/jlresume/mock/project.json'+Math.random(),{},function(response){
	      var html = '';
	      for(var i=0;i<response.length;i++){
	  ...
	  $('#footer div').eq(2).tap(function(){
	     $('#footer div').css({'background':'#444','color':'#fff'})
	      $(this).css({'background':'#e9e9e9','color':'#31B020'})  
	    $.getJSON('https://htmlzhoyan.github.io/jlresume/mock/work.json'+Math.random(),{},function(response){
	      var html = '';
	      for(var i=0;i<response.length;i++){
	  ...
	  $('#footer div').eq(3).tap(function(){
	     $('#footer div').css({'background':'#444','color':'#fff'})
	      $(this).css({'background':'#e9e9e9','color':'#31B020'})   
	    $.getJSON('https://htmlzhoyan.github.io/jlresume/mock/interest.json'+Math.random(),{},function(response){
	      var html = '';
	      for(var i=0;i<response.length;i++){
	  ...
	  $('#footer div').eq(4).tap(function(){
	     $('#footer div').css({'background':'#444','color':'#fff'})
	      $(this).css({'background':'#e9e9e9','color':'#31B020'})   
	    $.getJSON('https://htmlzhoyan.github.io/jlresume/mock/myself.json'+Math.random(),{},function(response){
	      var html = '';
	      for(var i=0;i<response.length;i++){
